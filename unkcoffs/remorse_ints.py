intrinsics = [
	...
	"byte I_probablyPickUpItem_037(4 bytes)",
	...
	"byte Intrinsic042(Item *, otheritem)",
	...
	"void I_SetNPCDataField0x6_052(Actor *, int)",
	...
	"byte I_probablyPickUpItem_0B8(4 bytes)",
	"int16 Actor::I_getLastAnimSet(4 bytes)",
	"void Item::I_setQuality(Item *, int)",
	...
	"int16 Item::I_hurl(Item *,8 bytes)",
	"void Item::I_andStatus(Item *, uint16 status)",
	"int16 I_showKeypadGump_0C4(int unk)",
	"byte Item::I_isOn(Item *, itemno)",
	...
	"int16 Actor::I_getLastAnimSet(4 bytes)",
	"void Actor::I_attackProbably(Actor *, uint16 target)",
